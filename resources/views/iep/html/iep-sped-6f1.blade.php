    ...
    <body>
                ...
                <table class="table table-bordered table-condensed">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Participate in the Alternate Assessment based on Alternate Achievement Standards (Essential Elements)</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="row">
            <div class="col-xs-12 box">
                <p class="text-center">
                    Details about the availability and allowability of each accommodation for any specific assessment are updated annually in the Utah Participation and Accommodations Policy found on the USOE website: <a href="http://www.schools.utah.gov/sars/Assessment.aspx">http://www.schools.utah.gov/sars/Assessment.aspx</a>
                </p>
                <p class="text-center">
                    Only mark accommodations for instruction and assessments that are needed by the student as documented in the IEP on the services/accommodations/program modifications and supports page. Attach to IEP.
                </p>
            </div>
        </div>
            ...
            <div class="col-xs-12">
                <table class="table table-condensed table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="border: none">Does the student’s disability significantly impact intellectual functioning and adaptive behavior?</td>
                        ...
                        <tr>
                            <td style="border-top: none">Does the student require extensive individualized instruction and supports to achieve measurable gains?</td>
                        ...
                        <tr>
                            <td colspan="3" style="border: none">Provide a statement explaining why this alternate assessment is appropriate for this student:<br>{{ str_repeat('&nbsp;', 5) }}{{ $responses->get('statement') }}</td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-bold text-center">The student may participate in the Alternate Assessment if <span class="text-underline">all responses</span> are marked Yes and the statement is provided.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
