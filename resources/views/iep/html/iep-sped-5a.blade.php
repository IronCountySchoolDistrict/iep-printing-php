...
<div class="row">
  <div class="col-xs-12">
    <p style="font-size: 0.9em">
      ...
      A developmental disability significantly affecting verbal and nonverbal communication and social interaction, generally evident before age 3, that adversely affects the student’s educational performance. Other characteristics often associated with autism are engagement in repetitive activities and stereotyped movements, resistance to environmental change or change in daily routines, and unusual responses to sensory experiences. Autism does not apply if a student’s educational performance is adversely affected primarily because the student has an emotional disturbance or an intellectual disability. A student who manifests the characteristics of autism after age 3 could be identified as having autism if the team determines that the student meets the definition of autism under Rule II.J.1. Autism may include other conditions included in the autism spectrum such as high functioning autism, Asperger syndrome, and pervasive developmental disorder not otherwise specified.
    </p>
  </div>
</div>
      ...
      <li>
        ...
        <ul>
          ...
          <li>
            ...
            <div class="right left-input">
              @include('iep.html._partials.checkbox', ['haystack' => $responses->get('primary-factor'), 'needle' => 'Yes']) Yes
              {{ str_repeat('&nbsp;', 5) }}
              @include('iep.html._partials.checkbox', ['haystack' => $responses->get('primary-factor'), 'needle' => 'No']) No
            </div>
          </li>
        </ul>
      </li>
      ...
      <p>
        <div class="row">
          <div class="col-xs-11 col-xs-offset-1">
            @include('iep.html._partials.checkbox', ['haystack' => $responses->get('action'), 'needle' => 'This student has Autism']) This student has Autism, as defined in the Individuals with Disabilities Education Act (IDEA), that adversely affects educational performance and requires special education and related services.
          </div>
        </div>
        <div class="row">
          <div class="col-xs-11 col-xs-offset-1">
            @include('iep.html._partials.checkbox', ['haystack' => $responses->get('action'), 'needle' => 'This student does NOT have Autism']) This student does <span class="text-bold text-underline">not</span> have Autism, as defined in the Individuals with Disabilities Education Act (IDEA) that adversely affects educational performance and does not require special education and related services.
          </div>
        </div>
      </p>
    </div>
