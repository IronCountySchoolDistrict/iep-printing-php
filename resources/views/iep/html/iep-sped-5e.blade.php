...
<div class="row">
  <div class="col-xs-9">
    {{ config('iep.district.name') }}{{ str_repeat('&nbsp;', 3) }}{{ $student->getSchoolCity() }}, {{ config('iep.district.state') }}
  </div>
...
<div class="row">
  <div class="col-xs-12 text-center">
    <h3>Team Evaluation Summary Report and Written Prior Notice of Eligibility Determination: Emotional Disturbance</h3>
  </div>
</div>
...
<div class="row">
  <div class="col-xs-12" style="font-size: 0.95em">
    <p>
      ...
      A condition exhibiting one or more of the following characteristics over a long period of time and to a marked degree that adversely affects a child’s educational performance:  1) an inability to learn that cannot be explained by intellectual, sensory, or health factors; 2) an inability to build or maintain satisfactory interpersonal relationships with peers and teachers; 3) inappropriate types of behavior or feelings under normal circumstances; 4)  a general pervasive mood of unhappiness or depression; 5) a tendency to develop physical symptoms or fears associated with personal or school problems.  The term includes schizophrenia.  “Emotional disturbance” is a term that covers two types of behavior difficulties which are not mutually exclusive but which adversely affect educational performance: 1)
      <span class="text-bold">Externalizing</span> refers to behavior problems that are directed outwardly by the student towards the social environment and usually involve behavioral excesses: 2)
      <span class="text-bold">Internalizing</span> refers to a class of behavior problems that are directed inwardly and often involve behavioral deficits.
    </p>
  </div>
</div>
...
<div class="row">
  ...
  <div class="col-xs-12">
    <p>
      <span class="text-bold">Disclaimers:</span> (may include data in cumulative records, interviews, classroom observations and/or evaluations).
       <br>{{ str_repeat('&nbsp;', 5) }}Is student behaving as a child with emotional disturbance because of: <small>(attach documentation when necessary)</small>
    </p>
  </div>
    ...
    <div class="row">
      <div class="col-xs-6">
        <p>
          ...
          @include('iep.html._partials.checkbox', ['haystack' => $responses->get('impairments'), 'needle' => 'Yes']) Yes
          {{ str_repeat('&nbsp;', 2) }}
          @include('iep.html._partials.checkbox', ['haystack' => $responses->get('impairments'), 'needle' => 'No']) No
        </p>
      </div>
      <div class="col-xs-6">
        Date of last screening:{{ str_repeat('&nbsp;', 4) }}{{ $responses->get('impairments-screening-date') }}
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-xs-6">
        <p>
          ...
          @include('iep.html._partials.checkbox', ['haystack' => $responses->get('other-medical'), 'needle' => 'Yes']) Yes
          {{ str_repeat('&nbsp;', 2) }}
          @include('iep.html._partials.checkbox', ['haystack' => $responses->get('other-medical'), 'needle' => 'No']) No
        </p>
      </div>
      <div class="col-xs-6">
    ...
    <div class="row">
      <div class="col-xs-6">
        <p>
          ...
          @include('iep.html._partials.checkbox', ['haystack' => $responses->get('inappropriate'), 'needle' => 'Yes']) Yes
          {{ str_repeat('&nbsp;', 2) }}
          @include('iep.html._partials.checkbox', ['haystack' => $responses->get('inappropriate'), 'needle' => 'No']) No
        </p>
      </div>
      <div class="col-xs-6">
...
<div class="row">
  <div class="col-xs-12">
    ...
    <ol>
      <li>
        Three 15-minute observations in classroom on behavior pinpoints attached (Required for initial evaluation only) (Attached observations are required for initial classification only. List observation dates)
        <div class="row">
          <div class="col-xs-4">
            <div class="left">
              I.
...
<div class="row">
  <div class="col-xs-12">
    <div class="left">
      Relevant&nbsp;medical&nbsp;problems?{{ str_repeat('&nbsp;', 4) }}@include('iep.html._partials.checkbox', ['haystack' => $responses->get('relevant'), 'needle' => 'Yes'])&nbsp;Yes{{ str_repeat('&nbsp;', 2) }}@include('iep.html._partials.checkbox', ['haystack' => $responses->get('relevant'), 'needle' => 'No'])&nbsp;No{{ str_repeat('&nbsp;', 6) }}If&nbsp;yes,&nbsp;specify:
    </div>
    <div class="right underline left-input">
    ...
    <ul>
      <li>
        <p>
          ...
          {{ str_repeat('&nbsp;', 4) }}
          @include('iep.html._partials.checkbox', ['haystack' => $responses->get('lack-instruction'), 'needle' => 'Yes']) Yes
          {{ str_repeat('&nbsp;', 2) }}
          @include('iep.html._partials.checkbox', ['haystack' => $responses->get('lack-instruction'), 'needle' => 'No']) No
        </p>
      </li>
      <li>
        <p>
  ...
  <div class="col-xs-12 box">
    ...
    <div class="row">
      <div class="col-xs-11 col-xs-offset-1">
        ...
        <div class="right left-input">
          This student has an Emotional Disturbance, as defined in the Individuals with Disabilities Education Act (IDEA), that adversely affects educational performance and requires special education and related services.
        </div>
      </div>
      <div class="col-xs-11 col-xs-offset-1">
        <div class="left">
        ...
        <div class="right left-input">
          This student does <span class="text-bold text-underline">not</span> have an Emotional Disturbance, as defined in the Individuals with Disabilities Education Act (IDEA), that adversely affects educational performance and does not require special education and related services.
        </div>
      </div>
    </div>
    ...
    <p>
      Other factors that are relevant to this eligibility classification proposal:{{ str_repeat('&nbsp;', 5) }}{{ $responses->get('other-factors') }}
    </p>
  </div>
</div>
