...
<div class="row" style="font-size: 0.9em">
  ...
  <div class="col-xs-12 text-center">
    <h3>Team Evaluation Summary Report and Written Prior Notice of Eligibility Determination: Visual Impairment (Including Blindness)</h3>
  </div>
</div>
...
<div class="row">
  <div class="col-xs-12">
    <p style="font-size: 0.9em">
      <span class="text-bold">Definition:</span> An impairment in vision that, even with correction, adversely affects a student’s educational performance.  The term includes both partial sight and blindness that adversely affects a student’s educational performance.
    </p>
  </div>
</div>
...
<div class="row">
  ...
  <div class="col-xs-12">
      ...
      {{ str_repeat('&nbsp;', 4)}}
      @include('iep.html._partials.checkbox', ['haystack' => $responses->get('other-impairments'), 'needle' => 'Yes']) Yes
      {{ str_repeat('&nbsp;', 3)}}
      @include('iep.html._partials.checkbox', ['haystack' => $responses->get('other-impairments'), 'needle' => 'No']) No
      <p>
  ...
  <div class="col-xs-12 box">
    ...
    <div class="row">
      <div class="col-xs-11 col-xs-offset-1">
        <div class="left">
          @include('iep.html._partials.checkbox', ['haystack' => $responses->get('action'), 'needle' => 'This student has a Visual Impairment'])
        </div>
        <div class="right left-input">
          This student has a Visual Impairment, as defined in the Individuals with Disabilities Education Act (IDEA), that adversely affects educational performance and requires special education and related services.
        </div>
      </div>
      <div class="col-xs-11 col-xs-offset-1">
        <div class="left">
          @include('iep.html._partials.checkbox', ['haystack' => $responses->get('action'), 'needle' => 'This student does NOT have a Visual Impairment'])
        </div>
        <div class="right left-input">
          This student does not have a Visual Impairment, as defined in the Individuals with Disabilities Education Act (IDEA), that adversely affects educational performance and does not require special education and related services.
        </div>
      </div>
    </div>
    <p></p>
