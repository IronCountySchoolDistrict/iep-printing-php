...
if ($goals > 0) {
  ...
  $cForms[] = (object)[
    'form' => (object)[
      'id' => "SpEd 6c - goals 1 & 2",
      'title' => 'SpEd 6c'
    ],
    'response' => [
      (object)[ 'field' => 'student', 'type' => 'text', 'response' => $student->getLastFirst() ],
      (object)[ 'field' => 'date-of-iep', 'type' => 'text', 'response' => $responses->get('date-of-iep') ],
      (object)[ 'field' => 'goal1', 'type' => 'text', 'response' => 1 ],
      (object)[ 'field' => 'goal1-description', 'type' => 'text', 'response' => $responses->get("goal1-description") ],
      ...
      (object)[ 'field' => 'goal1-short-term-objectives', 'type' => 'text', 'response' => $responses->get("goal1-short-term-objectives") ],
      (object)[ 'field' => 'goal2', 'type' => 'text', 'response' => 2 ],
      (object)[ 'field' => 'goal2-description', 'type' => 'text', 'response' => $responses->get("goal2-description") ],
      (object)[ 'field' => 'goal2-measured', 'type' => 'checkbox', 'response' => $responses->get("goal2-measured") ],
      (object)[ 'field' => 'goal2-measured-other', 'type' => 'text', 'response' => $responses->get("goal2-measured-other") ],
      (object)[ 'field' => 'goal2-report', 'type' => 'checkbox', 'response' => $responses->get("goal2-report") ],
      (object)[ 'field' => 'goal2-report-other', 'type' => 'text', 'response' => $responses->get("goal2-report-other") ],
      (object)[ 'field' => 'goal2-progress-date1', 'type' => 'text', 'response' => $responses->get("goal2-progress-date1") ],
      (object)[ 'field' => 'goal2-progress-code1', 'type' => 'text', 'response' => $responses->get("goal2-progress-code1") ],
      (object)[ 'field' => 'goal2-progress-date2', 'type' => 'text', 'response' => $responses->get("goal2-progress-date2") ],
      (object)[ 'field' => 'goal2-progress-code2', 'type' => 'text', 'response' => $responses->get("goal2-progress-code2") ],
      (object)[ 'field' => 'goal2-progress-date3', 'type' => 'text', 'response' => $responses->get("goal2-progress-date3") ],
      (object)[ 'field' => 'goal2-progress-code3', 'type' => 'text', 'response' => $responses->get("goal2-progress-code3") ],
      (object)[ 'field' => 'goal2-progress-date4', 'type' => 'text', 'response' => $responses->get("goal2-progress-date4") ],
      (object)[ 'field' => 'goal2-progress-code4', 'type' => 'text', 'response' => $responses->get("goal2-progress-code4") ],
      (object)[ 'field' => 'goal2-short-term-objectives', 'type' => 'text', 'response' => $responses->get("goal2-short-term-objectives") ]
    ]
  ];
}
