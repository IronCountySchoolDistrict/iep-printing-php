...
class HomeController extends Controller {
    ...
    public function index()
    {
        ...
        $responses = json_decode('[{"form":{"id":319384,"title":"IEP: SpEd 11","description":"Notice to Parents and Students Regarding Age of Majority Rights That Transfer under IDEA","type":"P"},"response":[{"field":"","type":"text","response":"05/05/2015"},{"field":"","type":"text","response":"05/05/2015"},{"field":"","type":"text","response":"05/05/2015"},{"field":"","type":"text","response":"just because"}]}]');
